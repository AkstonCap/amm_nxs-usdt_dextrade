...
module.exports = {
  ...
  paramSchema: {
    gridLow:               { label: 'Grid Low Price (USDT, 0=auto)',  type: 'number', min: 0, step: 0.0001 },
    gridHigh:              { label: 'Grid High Price (USDT, 0=auto)', type: 'number', min: 0, step: 0.0001 },
    gridRangePct:          { label: 'Auto Range (%)',                 type: 'number', min: 1, step: 1 },
    numGrids:              { label: 'Number of Grid Levels',          type: 'number', min: 2, max: 40, step: 1 },
    orderSize:             { label: 'Order Size (NXS)',               type: 'number', min: 1, step: 1 },
    rebalanceThresholdPct: { label: 'Rebalance Trigger (%)',          type: 'number', min: 1, step: 1 },
  },
  computeTargetOrders,
  needsRebalance,
};
